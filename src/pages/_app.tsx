  ...
  return (
    <Provider store={store}>
      <Head>
        ...
        <meta name='application-name' content='Teeth App' />
        <meta name='apple-mobile-web-app-capable' content='yes' />
        <meta name='apple-mobile-web-app-status-bar-style' content='default' />
        <meta name='apple-mobile-web-app-title' content='Teeth App' />
        <meta name='description' content='Best Teeth App in the world' />
